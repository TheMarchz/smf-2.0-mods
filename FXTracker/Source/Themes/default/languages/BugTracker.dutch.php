...
// Info Centre
$txt['info_centre'] = 'Info Centrum';
$txt['total_entries'] = 'Totaal aantal inzendingen:';
$txt['total_projects'] = 'Totaal aantal projecten:';
$txt['total_issues'] = 'Totaal aantal problemen:';
$txt['total_features'] = 'Totaal aantal functies:';
$txt['total_attention'] = 'Totaal aantal belangrijke inzendingen:';

// Entry View
$txt['view_title'] = '#%s - Bug Tracker';
$txt['entrytitle'] = 'Inzending num. #%d - %s';
$txt['description'] = 'Toelichting';
$txt['tracker'] = 'Tracker';
$txt['created_by'] = 'ingezonden door %s';

// Bug Tracker Index
$txt['bt_index'] = 'Tracker Index';
$txt['bt_latest'] = 'Laatste Inzendingen';
$txt['latest_issues'] = 'Laatste Problemen';
$txt['latest_features'] = 'Laatste Functies';
$txt['projects'] = 'Projecten';

// Errors / No permission
$txt['add_entry_noaccess'] = 'U heeft niet genoeg rechten om nieuwe inzendingen te maken.';
$txt['entry_no_exist'] = 'De aangevraagde inzending bestaat niet (meer).';
$txt['entry_no_project'] = 'De aangevraagde inzending heeft geen gassocieerd project. Neem contact op met de site administrator om de installatie van FXTracker te repararen.';
$txt['entry_is_private'] = 'De aangevraagde inzending is gemarkeerd als prive, U kunt het daarom niet bekijken.';
$txt['entry_unable_mark'] = 'U kunt deze inzending niet markeren.';
$txt['entry_mark_failed'] = 'Er is een fout opgetreden bij het markeren van deze inzending.';
$txt['entry_author_fail'] = 'De data van de tracker die bij deze inzending hoort bestaat niet of is corrupt.';
$txt['edit_entry_noaccess'] = 'U heeft niet genoeg rechten om deze inzending te bewerken.';
$txt['edit_entry_else_noaccess'] = 'U heeft niet genoeg rechten om de inzending van iemand anders te bewerken.';
$txt['no_entry_specified'] = 'Er is geen inzending gespecificeerd, daarom is er geen inzending geladen.';
